...
This context describes the scaffold decisions for a personal landing page. The visual language remains intentionally flexible until content and design work begin. Positioning/copy brief lives in `docs/PROFILE-CONTEXT.md` (in-repo authority); Alexander's personal positioning/self-branding vocabulary also lives in the solopreneur workspace (`positioning-language.md`). This document covers only the site's technical and content design.
